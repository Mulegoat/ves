								  ...
								  <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
									...
									<article id="post-<?php the_ID(); ?>" <?php post_class('twelvecol clearfix'); ?> role="article" data-id="<?php the_ID(); ?>">
										<div class="clearfix">
											...
											<header class="sixcol">
												<h2 class="h3 newsList__header box--theme3"><a class="newsList__header__link" href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
											</header>

											<section class="sevencol island">
												<?php the_excerpt(); ?>
											</section>
